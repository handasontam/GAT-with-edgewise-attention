...
def train(sparse, hid_units, n_heads, residual, edge_attr_directory, node_features_path, label_path, train_ratio, model_path):
    # flags = tf.app.flags
    # FLAGS = flags.FLAGS
...
if __name__ == '__main__':
    ...
    parser.add_argument("--model_path", type=str, help="the model path (e.g. ./pre_trained/mod_test.ckpt)")
    ...
    print(args)
    print()
    train(args.sparse, args.hid_units, args.n_heads, args.residual, 
        args.edge_attr_directory, 
        args.node_features_path, args.label_path, 
        args.train_ratio, args.model_path)
